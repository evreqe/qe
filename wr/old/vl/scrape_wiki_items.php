...
if ($file)
{
    while (($item_name = fgets($file)) !== false)
    {
        ...
        {
            echo 'Item Stats not found for: ' . $item_name . '<br>';
        ...
        if (strpos($item_stats, 'flagaug') === false) // skip augs
        {
            // slots
        ...
        if (strpos($item_name, '10 Dose') === false) // skip potions
        {
            // classes
