...
#define EQ_OFFSET_ZONE_OBJECT_INFO_NEXT                         0x04          // DWORD POINTER
#define EQ_OFFSET_ZONE_OBJECT_INFO_Y                            0x30          // FLOAT
#define EQ_OFFSET_ZONE_OBJECT_INFO_X                            0x34          // FLOAT
#define EQ_OFFSET_ZONE_OBJECT_INFO_Z                            0x38          // FLOAT
