...
filenames = [filename for filename in os.listdir(s3dfolder) if os.path.isfile(os.path.join(s3dfolder, filename)) if '.s3d' in filename]

for filename in filenames:

    filename = s3dfolder + filename
